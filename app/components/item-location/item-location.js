define(['jquery'], function($){
  ...
  var googleMapLoaded = function () {
    $googleMap.each(function() {
      ...
      if ($this.data('gmap-center-lat') && $this.data('gmap-center-lng')) {
        map_center = new google.maps.LatLng($this.data('gmap-center-lat'), $this.data('gmap-center-lng'));
      }

      var mapOptions = {
        zoom: $this.data('gmap-zoom') || 8,
        center: map_center,
      ...
      $gmapItem.each(function() {
        var $el = $(this);
        var position = new google.maps.LatLng($el.data('gmap-lat'), $el.data('gmap-lng'));
